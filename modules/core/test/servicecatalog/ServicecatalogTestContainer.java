...
public class ServicecatalogTestContainer extends TestContainer {

    public ServicecatalogTestContainer() {
        super();
    ...
    public static class Common extends ServicecatalogTestContainer {

        public static final ServicecatalogTestContainer.Common INSTANCE = new ServicecatalogTestContainer.Common();
